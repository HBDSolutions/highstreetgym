...
<html lang="en">
    ...
    <main style="max-width: 720px; margin: 2rem auto; font-family: system-ui, Arial, sans-serif;">
        ...
        <fieldset style="margin: 1rem 0;">
            ...
            <label><input type="radio" name="import_type" value="members" required> Members</label><br>
            <label><input type="radio" name="import_type" value="classes" required> Classes</label><br>
