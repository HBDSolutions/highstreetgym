                ...
                <tbody>
                  <?php if (isset($report['mode'])): ?>
                    <tr>
                      ...
                      <td><span class="badge bg-secondary"><?= htmlspecialchars($report['mode']) ?></span></td>
                    </tr>
                  <?php endif; ?>
                  ...
                  <?php if (isset($report['inserted'])): ?>
                    <tr>
                      ...
                      <td><span class="text-success fw-bold fs-5"><?= (int)$report['inserted'] ?></span></td>
                    </tr>
                  <?php endif; ?>
                  ...
                  <?php if (isset($report['updated'])): ?>
                    <tr>
                      ...
                      <td><span class="text-info fw-bold fs-5"><?= (int)$report['updated'] ?></span></td>
                    </tr>
                  <?php endif; ?>
                </tbody>
              </table>
