    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= is_active('blogcontroller.php') ?>" href="controllers/blogcontroller.php">Blog</a>
                </li>
                
                <?php if ($showMemberMenu): ?>
                    <!-- Logged In User Menu -->
                    <li class="nav-item">
                        <a class="nav-link <?= is_active('mybookings.php') ?>" href="controllers/mybookings.php">My Bookings</a>
                    </li>
