...
// TEMPORARY DEBUG - Step 2
$partialPath = __DIR__ . '/../../views/partials/blog/blog_posts.php';
echo "Looking for partial at: " . $partialPath . "<br>";
echo "File exists: " . (file_exists($partialPath) ? 'YES' : 'NO') . "<br>";

if (file_exists($partialPath)) {
    echo "File is readable: " . (is_readable($partialPath) ? 'YES' : 'NO') . "<br>";
} else {
    echo "Full path: " . realpath(__DIR__ . '/../../views/partials/blog/') . "<br>";
}
die('Debug stop');
